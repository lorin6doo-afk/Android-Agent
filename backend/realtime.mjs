...
const TOOLS = [
  ...
  { type: "function", name: "compose_message", description: "Za osebo, ki NI v seznamu obvestil: odpre WhatsApp pogovor z imenikovim stikom in pripravljenim besedilom. Sporočila NE pošlje — uporabnik ga pošlje sam s pritiskom na Pošlji.", parameters: { type: "object", properties: { contact: { type: "string", description: "ime stika iz imenika" }, text: { type: "string", description: "pripravljeno besedilo sporočila" } }, required: ["contact", "text"] } },
  { type: "function", name: "open_notification", description: "Odpre izbrano obvestilo na zaslonu telefona — enako kot dotik obvestila (odpre pogovor v WhatsAppu ipd.). Uporabi številko iz zadnjega read_notifications.", parameters: { type: "object", properties: { number: { type: "integer", description: "številka obvestila iz zadnjega seznama" } }, required: ["number"] } },
];
